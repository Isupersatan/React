                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form onSubmit={addItem}>
                                    ...
                                    <input type="submit" name="" id="" className="btn btn-dark" />
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <>
            <ul className="list-group gap-2">
                {items.map((item) => (
                    ...
                    <input className="form-check-input" type="checkbox" onClick={() => onCheck(item.id)} id="item.id" checked={item.carried}></input>
                        ...
                        <div className="card">
                            <div className="card-body bg-dark text-white text-center">
                               <h1>{percentage===100 && "All Items Packed You are ready to go."}</h1>
                                <h1>{totalItems === 0 ? "Your List is empty" : `You need to pack ${totalItems} items and packed ${packedItems} items (${percentage}%)`}</h1>
                            </div>
                        </div>
                    </div>
                </div>
